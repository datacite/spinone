class Relation < Base
  attr_reader :id, :subj_id, :obj_id, :doi, :author, :title, :container_title, :data_center_id, :source_id, :relation_type_id, :registration_agency_id, :work_type_id, :data_center, :source, :relation_type, :total, :published, :issued, :updated_at
