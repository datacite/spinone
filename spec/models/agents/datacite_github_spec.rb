...
describe DataciteGithub, type: :model, vcr: true do
  ...
  context "push_data" do
    ...
    it "should report if there are works returned by the Datacite Metadata Search API" do
      ...
      expect(deposit["data"]["deposit"]["subj"]).to eq("pid"=>"http://doi.org/10.5281/ZENODO.16396",
                                                       "author"=>[{"given"=>"Andrey", "family"=>"Fedorov"}, {"given"=>"Paul L", "family"=>"Nguyen"}, {"given"=>"Kemal", "family"=>"Tuncali"}, {"given"=>"Clare", "family"=>"Tempany"}],
                                                       "title"=>"Annotated MRI and ultrasound volume images of the prostate",
                                                       "container-title"=>"Zenodo",
                                                       "issued" => "2015-03-26T20:45:10Z",
                                                       "published"=>"2015",
